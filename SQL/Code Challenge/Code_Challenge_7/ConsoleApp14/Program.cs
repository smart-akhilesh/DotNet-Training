...
namespace CodeChallenge_7
{
    class Program
    {
        ...
        static void UpdateSalaryByEmpId()
        {
            ...
            SqlParameter paramUpdatedSalary = new SqlParameter();
            paramUpdatedSalary.ParameterName = "@updatedsalary";
            paramUpdatedSalary.DbType = DbType.Single; 
        ...
        static void InsertDataUsingProc()
        {
            ...
            paramSalary.Value = givenSalary;

            SqlParameter paramNetSalary = new SqlParameter();
            paramNetSalary.ParameterName = "@Netsalary";
            paramNetSalary.DbType = DbType.Double;
