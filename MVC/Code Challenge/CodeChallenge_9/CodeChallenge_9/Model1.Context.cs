...
namespace CodeChallenge_9
{
    ...
    public partial class northwindEntities : DbContext
    {
        ...
        [DbFunction("northwindEntities", "fn_getcus_bycountry")]
        public virtual IQueryable<fn_getcus_bycountry_Result> fn_getcus_bycountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_getcus_bycountry_Result>("[northwindEntities].[fn_getcus_bycountry](@country)", countryParameter);
        }
